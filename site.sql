...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 02 2021 г., 13:15
...
(1, 'Mitsubishi', 'X', 'Something', 1618571185, 1618571185, 'Автомобиль'),
(2, '234', '234', '234', 1618826360, 1618826360, 'Числа'),
(3, 'Mazda', '1', '2', 23, 2234, 'Автомобиль'),
(4, '123', '123', 'qwe', 1619184801, 1619184801, 'Числа'),
(5, '123', '123', '123', 1629127923, 1629127923, 'Числа'),
(6, 'Lada', 'Vesta', '', 1629359860, 1629359860, 'Автомобиль');
